...
function Pirate(id, gameId, time, reasonOfDeath, treasureHistory, attackHistory, defenseHistory, drinkHistory, attackRadiusHistory, robPowerupHistory, speedPowerupHistory) {
	this.id = id;
	this.gameId = gameId;
